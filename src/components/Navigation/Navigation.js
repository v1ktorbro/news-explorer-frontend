...
function Navigation({ onMain, loggedIn, onLogin }) {
  return (
    <nav className="navigation">
      <NavLink to="/" className={onMain ? 'navigation__link navigation__link_main' : 'navigation__link'} activeClassName={onMain ? 'navigation__link_active-main' : 'navigation__link_active'}>Главная</NavLink>
